...
from feeder.ntu_feeder import key_maping_from_NTU60ToPKU
...
class LE_Processor(Processor):
    ...
    def test(self, epoch):
        ...
        for data, label in loader:
            ...
            # labels_mapped = []
            # for i in list(torch.argmax(output, axis=1).cpu().numpy()):
            #     label_mapped = key_maping_from_NTU60ToPKU[str(i)] if str(i) in list(
